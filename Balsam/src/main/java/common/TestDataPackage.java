...
public class TestDataPackage {
	...
	public static TestDataPackage loadTestData(String sheet, String... where) throws Exception {
	...
	public static TestDataPackage loadTestData(Recordset record) throws Exception {
		TestDataPackage testDataPackage = new TestDataPackage();
		testDataPackage.url = record.getField("url");
		testDataPackage.searchBar = record.getField("Search Bar");
